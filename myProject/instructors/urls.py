...
from .views import HomeInstructorView, FunctionInstructorView, AnnounceInstructorView, CheckInInstructorView, ShowAttendanceView, ShowGraphView, EditCourseView
